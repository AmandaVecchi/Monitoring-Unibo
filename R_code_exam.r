...
RGB2018 <- ggRGB(image2018, r=4, g=3, b=2, stretch ="Lin")
plot(RGB2018)
    
visible2018 <- print(RGB2018 + ggtitle("RGB map - Sardinia, 2018")+ theme (axis.title.x = element_blank(),axis.title.y = element_blank()))    
...
RGB2018 <- ggRGB(image2021, r=4, g=3, b=2, stretch ="Lin")
plot(RGB2021) 
    
visible2021_print <- print(RGB2021 + ggtitle("RGB map - Sardinia, 2021")+ theme (axis.title.x = element_blank(),axis.title.y = element_blank()))    
